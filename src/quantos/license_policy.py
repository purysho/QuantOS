"""Dependency license policy for the proprietary First Current core.
...
def render_third_party_notices() -> str:
    ...
    lines = [
        "# Third-Party Notices",
        "",
        "First Current Quant OS is proprietary (see LICENSE). It does not "
        "vendor, modify or redistribute the packages below; they are "
        "installed separately from their own distributions under their own "
        "licenses. The versions in use are pinned in `uv.lock` and "
        "`requirements.lock`.",
        "",
